    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto max-w-3xl px-6 py-20 md:px-12 md:py-28">
        ...
        <p className="mb-6 font-sans text-sm font-light leading-relaxed text-foreground/75 md:text-base">
          Стандартные картриджи Coravin одноразовые — после использования выбрасываются. Многоразовый баллон для Coravin от Adderum работает иначе: после опустошения его просто заправляют аргоном заново и используют снова. Один баллон заменяет два оригинальных картриджа по объёму газа.
        </p>
        ...
        <p className="mb-6 font-sans text-sm font-light leading-relaxed text-foreground/75 md:text-base">
          Многоразовый картридж совместим с Coravin Pivot, Model Two, Three, Six, Eight и другими моделями линейки.
        </p>
        ...
        <p className="mb-10 font-sans text-sm font-light leading-relaxed text-foreground/75 md:text-base">
          Для ресторанов и винотек, которые разливают вино по бокалу каждый день, расходы на одноразовые картриджи Coravin накапливаются быстро. Многоразовый аналог Coravin от Adderеvinum окупается уже в первые месяцы использования и не производит мусора пустых капсул.
        </p>
